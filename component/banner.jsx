...
const Banner = () => {
  return (
    ...
    <div className=" px-5 py-24 mx-auto flex flex-wrap items-center justify-center">
      ...
      <div className=" xl:w-1/2   rounded-lg p-8 flex flex-col   md:mt-0">
        ...
        <button className="text-white xl:w-1/2 bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">SEND</button>
