...
function Header() {
  return (
   ...
   <link rel="stylesheet" href="./main.css"></link>
    ...
    <header  id="topnav" className="container mx-auto text-gray-600 body-font  defaultscroll bg-white is-sticky ">
       <nav className="bg-white py-2 flex flex-col lg:flex-row lg:items-center flex-shrink-0  pb-px-0 mb-0 ">
    ...
    <div className="hidden lg:flex flex-grow" id="navbar-collapse">
      ...
      <div className="flex my-3 lg:my-0">
        <button className="bg-transparent hover:bg-purple-700 text-purple-700 hover:text-white py-1 px-3 rounded border border-solid border-white mr-2">
          Sign In
        </button>
